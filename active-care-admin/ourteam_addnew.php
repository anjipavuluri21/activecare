...
{		
	...
	$login_query = "INSERT INTO activecare_ourteam (`title`,`content`,`thumbimg1`,`name`) VALUES ('$title', '$content', '$thumbimg1','$name')"; 
//        print_r($login_query).exit;
	...
	{			
		...
		if (($ext == "jpg") || ($ext == "jpeg") || ($ext == "png")) {
			...
			if (move_uploaded_file($_FILES['thumbimg1']['tmp_name'], $target_file1)) {	
				$login_query = "UPDATE activecare_ourteam SET thumbimg1='$basename1' WHERE id=$lastinsertid";
				$database1 = new Database();
				$dbCon1 = $database1->getConnection();
				$stmt1 = $dbCon1->prepare($login_query);  
				$stmt1->execute();
	...
	if($img_location!="")
	{		
		$login_query = "UPDATE activecare_ourteam SET thumimage1='$img' WHERE id=$lastinsertid";
		$database1 = new Database();
		$dbCon1 = $database1->getConnection();
		$stmt1 = $dbCon1->prepare($login_query);  
		$stmt1->execute();
	...
	if($res == 1 || $res1 == 1|| $res11 == 1|| $res12 == 1){
		...
		header("location:ourteam_addnew.php?msg=fail");		
	}	
}	
?>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="form-group">
                        ...
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Profile Name<span class="required">*</span>
                        </label>                        
						<div class="col-md-9 col-sm-9 col-xs-12">
