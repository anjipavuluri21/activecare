	  ...
	  <div class="">
		<div class="page-title">
		  <div class="title_left">
			<h3>Home Program Requests</h3><hr>
		  </div>             
		</div>
				  ...
				  <table id="datatable" class="table table-striped jambo_table bulk_action">
					<thead>
					  <tr class="headings">                            
						...
						<th width="150" class="column-title">Program Type</th>			 
					...
					<?php
					$i = 1;
					$banner_que = "SELECT * from activecare_e_book_request where 1=1 ORDER BY id DESC";
					...
					?>
					  <tr class="even pointer">                            
						...
						<td class=" "><?php echo $banner_result['email'] ?></td>
                                                ...
                                                <td class=" "><?php echo $banner_result['program_type'];?></td>
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=e_books",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=e_books",
			success:function(data)
			{
				if(data=="done")
				{
