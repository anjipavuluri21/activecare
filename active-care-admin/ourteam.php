	...
	<div class="right_col" role="main">
	  <div class="">
		...
		<div class="clearfix"></div>			
			<a align="right" href="ourteam_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Our Team</button></a>			
		<div class="clearfix"></div>
		<div class="row">           
		  <div class="clearfix"></div>
			  ...
			  <div class="x_content"> 
				<div class="table-responsive">
				  <table id="datatable" class="table table-striped jambo_table bulk_action">
					...
					<?php
					$i = 1;
					$banner_que = "SELECT * from activecare_ourteam where 1=1 ORDER BY id DESC";
					...
					?>
					  <tr class="even pointer">                            
						...
						<td class=" "><?php echo $banner_result['name'] ?></td>
                                                <td class=" "><img src="../uploads/ourteam/<?php echo $banner_result['thumbimg1'] ?>" height="50" width="50"/></td>
						...
						<?php } ?>
                                                ...
                                                <a class="btn btn-info" href="ourteam_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=ourteam",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=ourteam",
			success:function(data)
			{
				if(data=="done")
				{
