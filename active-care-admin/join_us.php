	  ...
	  <div class="">
		<div class="page-title">
		  <div class="title_left">
			<h3>New_Requests to Join Us</h3><hr>
		  </div>             
		</div>
			  ...
			  <div class="x_content"> 
				<div class="table-responsive">
				  <table id="datatable" class="table table-striped jambo_table bulk_action">
					...
					<?php
					$i = 1;
					$banner_que = "SELECT * from activecare_newrequests where 1=1 ORDER BY id DESC";
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=join_us",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=join_us",
			success:function(data)
			{
				if(data=="done")
				{
