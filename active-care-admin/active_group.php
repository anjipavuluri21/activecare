				  ...
				  <table id="datatable" class="table table-striped jambo_table bulk_action">
					<thead>
					  <tr class="headings">                            
						...
						<th width="105" class="column-title">Name</th>
						<th width="100" class="column-title">Email</th>			 
						<th width="150" class="column-title">Mobile</th>			 
								 
						<th width="150" class="column-title">Title</th>			 
						<th width="150" class="column-title">Country</th>			 
					...
					<?php
					$i = 1;
					$banner_que = "SELECT * from activecare_complete_purchase_order where 1=1 ORDER BY id DESC";
					...
					?>
					  <tr class="even pointer">                            
						...
						<td class=" "><?php echo $banner_result['first_name'] ?></td>
						<td class=" "><?php echo $banner_result['email'] ?></td>
                                                ...
                                                <td class=" "><?php echo $banner_result['country'];?></td>
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=purchase_order",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=purchase_order",
			success:function(data)
			{
				if(data=="done")
				{
